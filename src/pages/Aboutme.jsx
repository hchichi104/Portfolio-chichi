      ...
      <div className={styles.container}>
        ...
        <div className={styles.cont}>
          ...
          <div className={styles.resume} data-aos="fade-up" data-aos-delay="800">
            ...
            <p>
              <span>
                안녕하세요! 사람들의 호기심을 쫓는 웹퍼블리셔 황지훈입니다. <br />
                저는 모든 콘텐츠를 하나의 ‘이야기’라고 생각합니다.
                이 포트폴리오도 저의 이야기가 담긴 편지로 다가갔으면 좋겠습니다.
              </span>
            </p>
            <a href="https://drive.google.com/file/d/1O99Wjxso4WFBhCYAaGybl5i1zQMdULYV/view?usp=sharing" target="_blank" rel="noopener noreferrer">View More</a>
          </div>
